  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 pb-20">
      ...
      <div className="flex flex-col my-5 mx-10 justify-center items-center">
        <h1 className="text-4xl font-bold font-sans my-5">UNPAID LAB TEST BILLS</h1>
      </div>
              ...
              >
                <div className="ms-5 mt-3 flex justify-between items-center w-full">
                  <div className="flex items-center">
                    <IoPersonOutline className="w-12 h-12 text-green-500" />
                  ...
                  <div className="flex flex-col items-end me-5">
                    <div className="flex my-2 items-center">
                      <p className="me-3 text-xl">{bill.doctorName}</p>
                      <FaUserDoctor className="w-8 h-8" />
                    </div>
                    <div className="flex my-2 items-center">
                      <p className="me-3 text-xl">{formatDate(bill.date)}</p>
                      <FaRegCalendarAlt className="w-8 h-8" />
                    </div>
                    <div className="flex my-2 items-center">
                      <p className="me-3 text-xl font-semibold text-green-600">
                        {formatCurrency(bill.totalUnpaidAmount)}
                      </p>
                      <BsCurrencyDollar className="w-8 h-8 text-green-500" />
                    </div>
                  </div>
                </div>
              </div>
